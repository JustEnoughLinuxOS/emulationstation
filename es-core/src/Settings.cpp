...
#if defined(_WIN32) || defined(TINKERBOARD) || defined(X86) || defined(X86_64) || defined(ODROIDN2) || defined(ODROIDC2) || defined(ODROIDXU4) || defined(RPI4) || defined(RG552) || defined(RG353P) || defined(handheld)
	// Boards > 1Gb RAM
	mIntMap["MaxVRAM"] = 256;
